<?php global $s_v_data, $user, $title, $client, $notes, $project, $staffmembers, $tasks, $expenses, $quotes, $invoices, $payments, $jobcards, $suppliers, $inventory; ?>
                                                    ...
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                ...
                                                                <?php } ?>
                                                                <?php if ($project->status == "In Progress" && $user->role == "Admin" || $project->status == "In Progress" && $user->role == "Owner" || $project->status == "In Progress" && $user->role == "Manager") { ?>
                                                ...
                                                <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                                    <li class="nav-item">
                                                        ...
                                                        <?php if (!isset($_GET['view'])) { ?>
                                                         active
                                                         <?php } ?>" href="<?=  url('Projects@details', array('projectid' => $project->id)) ; ?>?details"><em class="icon ni ni-file-text"></em><span>Details</span></a>
                                                    </li>
                                                    <?php if ($user->role == "Owner" || $user->role == "Admin" || $user->role == "Manager") { ?>
                                                    <li class="nav-item">
                                                        <a class="nav-link
                                                        <?php if (isset($_GET['view']) && $_GET['view'] == 'jobcards') { ?>
                                                         active
                                                         <?php } ?>" href="<?=  url('Projects@details', array('projectid' => $project->id)) ; ?>?view=jobcards"><em class="icon ni ni-property-add"></em><span>Job Cards</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link
                                                        <?php if (isset($_GET['view']) && $_GET['view'] == 'tasks') { ?>
                                                         active
                                                         <?php } ?>" href="<?=  url('Projects@details', array('projectid' => $project->id)) ; ?>?view=tasks"><em class="icon ni ni-todo"></em><span>Tasks</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link
                                                        <?php if (isset($_GET['view']) && $_GET['view'] == 'expenses') { ?>
                                                         active
                                                         <?php } ?>" href="<?=  url('Projects@details', array('projectid' => $project->id)) ; ?>?view=expenses"><em class="icon ni ni-cart"></em><span>Parts & Expenses</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link
                                                        <?php if (isset($_GET['view']) && $_GET['view'] == 'invoices') { ?>
                                                         active
                                                         <?php } ?>" href="<?=  url('Projects@details', array('projectid' => $project->id)) ; ?>?view=invoices"><em class="icon ni ni-cc"></em><span>Invoices</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link
                                                        <?php if (isset($_GET['view']) && $_GET['view'] == 'quotes') { ?>
                                                         active
                                                         <?php } ?>" href="<?=  url('Projects@details', array('projectid' => $project->id)) ; ?>?view=quotes"><em class="icon ni ni-cards"></em><span>Quotes</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link
                                                        <?php if (isset($_GET['view']) && $_GET['view'] == 'payments') { ?>
                                                         active
                                                         <?php } ?>" href="<?=  url('Projects@details', array('projectid' => $project->id)) ; ?>?view=payments"><em class="icon ni ni-align-left"></em><span>Payments</span></a>
                                                    </li>
                                                    <?php } ?>
                                                </ul><!-- .nav-tabs -->
                                                <?php if (!isset($_GET["view"])) { ?>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="number" class="form-control form-control-lg expense-total-amount" placeholder="Amount" data-parsley-pattern="^[0-9]\d*(\.\d+)?$" name="totalamount" value="0.00" step="0.01" required="" readonly="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
