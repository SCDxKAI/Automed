                            ...
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="<?=  url('Projectpayment@get') ; ?>" class="nk-menu-link"><span class="nk-menu-text">Payments</span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li><!-- .nk-menu-item -->
                                <?php } ?>
                                ...
                                <li class="nk-menu-item">
                                    <a href="<?=  url('Marketing@get') ; ?>" class="nk-menu-link">
                                        ...
                                        <span class="nk-menu-text">Online Slots</span>
                                    </a>
                                </li><!-- .nk-menu-item -->
                                <?php } ?>
                                <li class="nk-menu-heading">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="<?=  url('Plans@overview') ; ?>" class="nk-menu-link"><span class="nk-menu-text">Overview</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="<?=  url('Companies@get') ; ?>" class="nk-menu-link"><span class="nk-menu-text">Companies</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="<?=  url('Plans@get') ; ?>" class="nk-menu-link"><span class="nk-menu-text">Pricing Plans</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="<?=  url('Plans@payments') ; ?>" class="nk-menu-link"><span class="nk-menu-text">Payments</span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li><!-- .nk-menu-item -->
                                <?php } ?>
