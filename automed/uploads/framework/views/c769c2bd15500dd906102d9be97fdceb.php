...
<body class="nk-body bg-lighter npc-default has-sidebar ">
    ...
    <script>
      function makePayment(amount) {
        FlutterwaveCheckout({
          public_key: "<?=  env('FLUTTER_PUBKEY') ; ?>",
          tx_ref: "<?=  uniqid('Asilify_') ; ?>",
          amount: amount,
          currency: "KES",
          payment_options: "card, mpesa",
          redirect_url: "<?=  env('APP_URL') ; ?>/billing/topup/transaction",
          customer: {
            email: "<?=  $user->email ; ?>",
          ...
          customizations: {
            title: "Asilify",
            description: "Topup SMS credits. KSh1 is equal to 1 credit",
            logo: "<?=  env('APP_URL') ; ?>/assets/images/favicon.png",
          },
        });
      }
</script>
