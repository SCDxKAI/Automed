...
class Auth {
    ...
    public function createaccount() {
        ...
        Mail::send(
            ...
            array(
                "message" => "Thank you for signing up, ".input('fname')."<br><br>We built ".env("APP_URL")." to help Auto Garages all over the world automate their daily operations while increasing perfomance and accountability. We're here to ensure your success and increased perfomance. ".env("APP_URL")." is for you.<br><br>All the best,<br><br>".env("APP_NAME")." Team"
            )
        );
