...
class Database {
    ...
    protected function addConditions(array $pairs, $comparator, $operator) {
        foreach($pairs as $field => $value) {
            if ($comparator == "IN" || $comparator == "NOT IN" || $comparator == "IS" || $comparator == "IS NOT") {
    ...
    public function get() {
        ...
        // echo "SELECT {$this->getFields()} FROM {$this->tableName} WHERE {$this->getConditions()}{$this->order}{$this->limit}";
     ...
     * @return bool
     */
    public function insert(array $field_value_pairs, $print = false) {
